...
router.post('/', function (req, res) {
    ...
    var email_check_code_sql = 'INSERT INTO email_checker (check_final) VALUES (?);';
    ...
    connection.query(email_check_sql, [Email_check],
        function (error, result, fields) {
            ...
            if (result[0] != 0 || Email_check == '') { // 인증코드가 틀리거나 입력하지 않으면
                console.log('꺄아아아아아--->',result[0]);
                ...
                connection.query(email_check_code_sql, [1],
                    function (error, result, fields) {
